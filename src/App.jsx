    ...
    <>
      <div className="">
        ...
        <main className="w-9/12 xl:w-4/12 top-20 mx-auto py-16">
          <div
            id="modal"
            className=" p-6 h-auto rounded-xl shadow-xl bg-white w-[348px] sm:w-auto my-0 mx-auto"
          >
            ...
            <p className="font-bold text-lg flex justify-between mb-8 text-principal items-center gap-6">
              What is Front Mentor, and how will it help me?
              <span>
                <img
                  src={minusIcon}
                  alt="minus icon"
                  className="h-[3rem] min-w-[46px]"
                />
              </span>
            </p>
            ...
            {faq.map((item, index) => {
              return (
                <p
                  className="flex items-center justify-between text-principal font-bold mb-8 gap-6 hover:text-terciaria cursor-pointer"
                  key={index}
                >
                  {item}
                  <span>
